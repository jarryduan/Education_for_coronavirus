...
% Last Modified by GUIDE v2.5 12-Apr-2020 22:10:25
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
choice3 = get(handles.radiobutton6,'Value');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
choice1 = get(handles.radiobutton4,'Value');
choice2 = get(handles.radiobutton6,'Value');
choice3 = get(handles.radiobutton5,'Value');
